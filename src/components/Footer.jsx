  ...
  return (
    <footer style={{ 
      ...
      <div style={{ marginBottom: '20px' }}>
        <h3 style={{ color: '#FFF', fontSize: '1.6rem', marginBottom: '12px', fontWeight: 'bold' }}>
          Punto y Coma Camarón
        </h3>
        <p style={{ margin: '5px 0', fontSize: '1.05rem', color: '#CCC' }}>
          📍 Entregas a domicilio en Ciudad Granja y alrededores
        </p>
        <p style={{ margin: '5px 0', fontSize: '1.05rem', color: '#CCC' }}>
          🛵 Tu comida fresca y segura hasta tu puerta
        </p>
      </div>
